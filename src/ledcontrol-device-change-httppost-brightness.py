"""
File:	ledcontrol-device-change-httppost-brightness.py
Date:	20230409
Author: Robert W.B. Linn
PicoW RESTful webserver listening to set the state of an LED via Domoticz Dimmer Switch.
...
:commands
LED ON:
curl -v -H "Content-Type: application/json" -d "{\"led\":\"red\",\"cmd\":\"on\",\"value\":0}" http://webserver-ip
{"status": "OK", "title": {"led": "red", "value": 0, "cmd": "on"}, "message": "on"}
LED OFF:
curl -v -H "Content-Type: application/json" -d "{\"led\":\"red\",\"cmd\":\"off\",\"value\":0}" http://webserver-ip
