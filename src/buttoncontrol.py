...
import config
# Constants
NAME = const('ButtonControl')
VERSION = const('v20230425')
...
# Button K4 pin
BUTTON_PINNR = const(20)
# Button K4 object
btn = Button(BUTTON_PINNR)
# Status of the switch On or Off (used as global)
switch_status = "Off"
...
btn.when_pressed = set_domoticz_switch
"""
Main
"""
...
network.connect2()
"""
Press the button to set the switch state On or Off.
"""
while True:
    pass
